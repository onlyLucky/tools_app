 ...
 */
export function useMobile(onChange?: (isMobile: boolean) => void): { mobile: Ref<boolean> } {
 ...
 * @param onChange 值改变回调
 */
export function useMobileDevice(onChange?: (isMobileDevice: boolean) => void): { mobileDevice: Ref<boolean> } {
